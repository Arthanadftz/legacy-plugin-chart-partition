  ...
  controlPanelSections: [{
    ...
    controlSetRows: [[{
      ...
      config: {
        ...
        optionRenderer: op => /*#__PURE__*/React.createElement(OptionDescription, {
          option: op
        }),
        valueRenderer: op => /*#__PURE__*/React.createElement(OptionDescription, {
          option: op
        }),
    ...
    controlSetRows: [['color_scheme', 'label_colors'], [{
      ...
      config: {
        ...
        isFloat: true,
        default: '0.05',
        description: t('Partitions whose height to parent height proportions are ' + 'below this value are pruned')
      }
    }], [{
      name: 'log_scale',
      config: {
